...
rc162_ok(str_contains($main, 'Version: 0.4.0-RC1.7.0') && str_contains($main, "define('IDG_VERSION', '0.4.0-RC1.7.0')"), 'versión RC1.7.0 consistente');
...
foreach ($expected_hashes as $path => $hash) {
    rc162_ok(IDG_Canonical_Regression::historical_matches($root, $path, $hash), "equivalencia SHA-256 de {$path}");
}
