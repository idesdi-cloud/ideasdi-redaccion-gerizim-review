...
rc170_ok((bool) preg_match('/Version:\s*0\.4\.0-RC1\.6\.5\s*$/m', $main), 'plugin version unchanged');
// Protected source fingerprints at baseline 2cab833263d1e9c6e870d221818cb9f6dac60b0b.
$protected = [
