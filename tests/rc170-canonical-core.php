...
$contracts = [
    'knowledge_id' => 'editorial.canonical', 'schema_version' => 1, 'canonical_version' => '1.1.0',
    ...
    'global.writing_principles' => ['show_before_explaining_importance' => true, 'non_promotional' => true, 'open_disciplinary_language' => true, 'avoid_press_release_voice' => true, 'avoid_catalogue_voice' => true, 'thesis_should_be_shown_not_announced' => true, 'concrete_design_decisions_first' => true, 'explain_design_decisions_not_only_features' => true, 'follow_decision_to_relevant_consequence_then_stop' => true, 'abstraction_and_qualities_after_concrete_evidence' => true, 'author_intent_requires_documentation' => true, 'avoid_meta_editorial_language_when_it_replaces_observation' => true, 'authorship_is_transversal_and_tied_to_concrete_decisions' => true, 'category_appropriate_experience_and_perception_vocabulary' => true, 'avoid_overexplaining_interpret_only_for_new_relation' => true],
    'surfaces.article.title' => ['scope' => 'editorial_h1_not_seo_title', 'preferred_max_chars' => 60, 'hard_max_chars' => 68],
    'surfaces.article.introduction' => ['standard_paragraphs' => 2, 'enforcement' => 'preferred', 'purpose' => ['identify_subject', 'establish_relevance', 'establish_editorial_angle', 'orientation_from_design', 'central_design_decisions', 'editorial_direction', 'avoid_editorial_box_repetition'], 'non_rigid' => true],
    'surfaces.article.editorial_box' => ['required' => true, 'min_words' => 40, 'max_words' => 55, 'must_answer' => ['what_it_is', 'who_is_responsible', 'for_whom_when_relevant', 'origin_or_current_state_when_relevant', 'essential_objective_traits'], 'forbidden' => ['links', 'bold', 'promotional_language'], 'position' => 'after_introduction', 'guardrails' => ['primarily_factual' => true, 'do_not_repeat_editorial_thesis' => true, 'do_not_advance_body_analysis' => true]],
    'surfaces.article.headings' => ['hierarchy_required' => true, 'style' => 'descriptive_and_concise', 'analysis_axis_clear_without_forcing_full_thesis' => true, 'analysis_axis_guidance' => 'non_rigid', 'avoid' => 'single_underdeveloped_paragraph', 'merge_or_expand_when_needed' => true],
