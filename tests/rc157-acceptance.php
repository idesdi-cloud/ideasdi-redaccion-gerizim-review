...
rc157_accept(str_contains($main, 'Version: 0.4.0-RC1.7.0') && str_contains($main, "define('IDG_VERSION', '0.4.0-RC1.7.0')"), 'Observabilidad RC1.5.7 preservada en RC1.7.0');
...
echo "PASS RC1.5.7 observability preserved in RC1.7.0\n";
