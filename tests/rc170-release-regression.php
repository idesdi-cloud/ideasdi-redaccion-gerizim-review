...
release_ok(preg_match('/^ \* Version: 0\.4\.0-RC1\.7\.2$/m', $main) === 1, 'exact header');
release_ok(str_contains($main, "define('IDG_VERSION', '0.4.0-RC1.7.2');"), 'exact runtime version');
...
$text = file_get_contents($root . '/REGRESION-EDITORIAL-RC1.7.2.sha256');
$current = IDG_Canonical_Regression::parse($text);
release_ok(!isset($current['REGRESION-EDITORIAL-RC1.7.2.sha256']), 'no self reference');
